...
EXAMPLES
  ...
  translation-toolkit validate --cross-format json --format-dir locales/json/ --dir src/i18n
  ...
  translation-toolkit export --format json -o locales/
  translation-toolkit import --format json locales/ --dir src/i18n
  translation-toolkit export --format i18next -o locales/
